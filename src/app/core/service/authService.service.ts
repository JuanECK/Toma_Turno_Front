...
// perfil:4 = Ticketero
  ...
  perfiles:perfilCajero[] = [
    {nombreCajero:'Jorge Alvarez', email:'jorge@tornillo', password:'123', idCajero:1, perfil:2},
    {nombreCajero:'Pedro Paramo', email:'pedro@tornillo', password:'123', idCajero:2, perfil:2},
    {nombreCajero:'Juan Soto', email:'juan@tornillo', password:'123', idCajero:3, perfil:1},
    {nombreCajero:'pantalla', email:'pantalla@tornillo', password:'123', idCajero:4, perfil:4},
    {nombreCajero:'ticketero', email:'ticketero@tornillo', password:'123', idCajero:4, perfil:5},
  ]
